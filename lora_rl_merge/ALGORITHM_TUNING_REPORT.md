...
> 状态说明（2026-09-11）：补丁后的独立四卡轨迹已连续完成 1–100 步，全部 100 步没有非有限 rollout 诊断、没有零梯度步，首末十步 reward 由 0.3946 升到 0.9270，checkpoint100 与最终验证齐备，进程退出码为 0。第 1–90 步在 4 × 910B1、第 91–100 步在 4 × 910B3，吞吐分别为 702.64 与 574.36 tokens/s/NPU，按段披露。原版 sampler 的轨迹每步仍有非有限 rollout 诊断，保留作对照。第 100 步的 GSM8K 验证低于第 80 步与第 90 步，详见 6.6。
...
| 100 步 / 长跑 | 补丁版已连续完成 1–100 步：非有限 rollout 诊断为 0，首末十步 reward 0.3946 → 0.9270，四卡分母吞吐 702.64（910B1，1–90 步）与 574.36（910B3，91–100 步），checkpoint100 与最终验证齐备，退出码 0。原版轨迹保留作对照。 |
